...
export interface TimeCardRes {
    timeframes: {
        daily: TimeProperty,
        monthly: TimeProperty,
        weekly: TimeProperty
    },
    title: string
}

export type View = 'daily' | 'monthly' | 'weekly'

interface TimeCardProps {
    timecard: TimeCardRes,
    view: View
}